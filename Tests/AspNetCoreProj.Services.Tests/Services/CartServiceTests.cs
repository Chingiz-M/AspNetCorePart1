...
namespace AspNetCoreProj.Services.Tests.Services
{
    [TestClass]
    public class CartServiceTests
    {
        ...
        public void Cart_Class_ItemsCount_returns_Correct_Quantity()
        {
            ...
            var actual_items_count = cart.ItemsSum;
        ...
        public void CartViewModel_Returns_Correct_ItemsCount()
        {
            ...
            var actual_items_count = cart_view_model.ItemsSum;
        ...
        public void CartService_Add_WorkCorrect()
        {
            ...
            var actual_items_count = _Cart.ItemsSum;
        ...
        public void CartService_Decrement_Correct()
        {
            ...
            Assert.Equal(expectes_items_count, _Cart.ItemsSum);
        ...
        public void CartService_Remove_Item_When_Decrement_to_0()
        {
            ...
            Assert.Equal(expected_items_count, _Cart.ItemsSum);
            Assert.Single(_Cart.Items);
        }
        ...
        public void CartService_GetViewModel_WorkCorrect()
        {
            ...
            Assert.Equal(expected_items_count, result.ItemsSum);
